...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient- #222831">
  <div class="container  ">
    ...
    <!-- <a class="navbar-brand" href="./">
      <img src="<?php echo validate_image($_settings->info('logo')) ?>" width="30" height="30"
        class="d-inline-block align-top border-radius=20px" alt="" loading="lazy">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="./?p=categories">Topics</a></li>
        ...
        <?php if ($_settings->userdata('id') != '' && $_settings->userdata('type') == 2): ?>
          ...
          <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="./?p=posts/manage_post"><i
                class="far "></i> Add Post</a></li>
        <?php endif; ?>
      ...
      <div class="d-flex align-items-center">
        <?php if ($_settings->userdata('id') > 0 && $_settings->userdata('type') == 2): ?>
          <div class="btn-group">
            <button type="button" class="btn btn-rounded badge badge-light dropdown-toggle dropdown-icon user-dd"
            ...
            <div class="dropdown-menu" role="menu">
              <a class="dropdown-item" href="<?php echo base_url . './?p=user' ?>"><span class="fa fa-user"></span> My
                Profile</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="<?php echo base_url . '/classes/Login.php?f=logout_user' ?>"><span
                  class="fas fa-sign-out-alt"></span> Logout</a>
            </div>

          </div>
        <?php else: ?>
          <a class="font-weight-bolder text-light pr-3 mx-2 text-decoration-none border-right"
            href="./login.php">Login</a>
          <a class="font-weight-bolder text-light pr-3 mx-2 text-decoration-none border-right" href="./register.php">Sign
            up</a>
