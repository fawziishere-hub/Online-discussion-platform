...
<div class="card  rounded-20 card-gray">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=posts/manage_post" id="" class="btn  btn-primary"><span class="fas fa-plus"></span>
				Create New</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									<a class="dropdown-item" href="./?page=posts/view_post&id=<?= $row['id'] ?>"
										data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span>
										View</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
										href="./?page=posts/manage_post&id=<?php echo $row['id'] ?>"><span
