...
<div class="col-lg-12">
	<div class="card  rounded-20 card-gray">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<textarea name="content[about]" id="" cols="30" rows="2"
				...
				<!-- <div class="form-group">
					...
					<div class="custom-file">
						<input type="file" class="custom-file-input rounded-circle" id="customFile3" name="banners[]"
							multiple accept=".png,.jpg,.jpeg" onchange="displayImg3(this,$(this))">
				...
				if (is_dir(base_app . $upload_path)):
					...
					foreach ($file as $img):
						...
						<!-- <div class="d-flex w-100 align-items-center img-item">
							<span><img src="<?php echo base_url . $upload_path . '/' . $img . "?v=" . (time()) ?>" width="150px"
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<div class="d-flex justify-content-center w-100"> <button class="btn btn-sm btn-primary"
							form="manage-user">Update</button> </div>
				</div>
			</div>
		</div>
