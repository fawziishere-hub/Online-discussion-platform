            ...
            <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                <div class="input-group input-group-lg" id="search-field">
                    <input type="search" class="form-control form-control-lg  rounded-pill"
                        aria-label="Search Post Input" id="search" placeholder="Search post here">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="mb-2 text-end">
                                <small class="badge badge-secondary  text-light rounded-pill px-3"><i class="far "></i>
                                    <?= $row['category'] ?></small>
                                <?php if ($row['status'] == 1): ?>
                                    <small class="badge badge-secondary text-light rounded-pill px-3"><i
                                            class="fa fa-circle text-primary"></i> Published</small>
                                <?php else: ?>
                                    <small class="badge badge-light  text-dark rounded-pill px-3"><i
